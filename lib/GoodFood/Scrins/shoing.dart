...
Text("is Empty Cart",style: TextStyle(fontSize: 50,color: Colors.black38),),
      ],
      ...
      child: Column(
        children: [
          ...
          Stack(children: [
            CircleAvatar(radius: 80,child: Text("${calculetSumm(cart,)}",style: TextStyle(fontSize: 50),))

          ],),
          Expanded(child: ListView.builder(itemCount: cart.length,itemBuilder: (context, index) => Costomcart(cartFood:cart[index] ),))
      ,
